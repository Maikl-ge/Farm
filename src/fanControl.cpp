...
const int MIN_CIRCULATION_PWM = 250;   // Минимальное значение PWM для вентилятора циркуляции
const int MIN_VENTILATION_PWM = 150;   // Минимальное значение PWM для приточного вентилятора
